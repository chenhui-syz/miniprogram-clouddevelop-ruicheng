...
Component({
    ...
    methods: {
        ...
        calendarChange(e) {
            ...
            //发送事件监听
            this.triggerEvent('changeCalendar', this.data.selectIndex);
        },
        //切换展示
        toggleType() {
            console.log(this.properties.toggleType)
            this.setData({
                toggleType: this.properties.toggleType == 'mini' ? 'large' : 'mini'
            })
            //初始化日历组件UI
